#!/usr/bin/env bash
# =============================================================================
# Logistics UI Build and Deploy Script
# =============================================================================
...
# Configuration
APP_NAME=${APP_NAME:-"logistics-ui"}
...
GIT_USER=${GIT_USER:-"Logistics UI Bot"}
...
NEXT_PUBLIC_API_URL=${NEXT_PUBLIC_API_URL:-"https://logisticsapi.codevertexitsolutions.com/api/v1"}
